# ==============================================================================
#  14_amortized_axis_n_remlbf.R
#  Plug-in REML (REML-BF) mirror of 10_amortized_axis_n.R
#  n in {500, 1000, 3000} x sigma_g2 in {0, 0.5} -> 6 cells x B reps
#
#  Run: Rscript sim/bench_full/14_amortized_axis_n_remlbf.R --cores 6 --B 100
# ==============================================================================
...
source("sim/bench_full/01_utils_remlbf.R")
