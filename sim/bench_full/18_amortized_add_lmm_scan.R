...
#
# Usage:
#   Rscript sim/bench_full/18_amortized_add_lmm_scan.R                       # all 4 dirs, default cores
#   Rscript sim/bench_full/18_amortized_add_lmm_scan.R --dir 01              # only dir 01
#   Rscript sim/bench_full/18_amortized_add_lmm_scan.R --cores 30            # 30-worker mclapply
#   Rscript sim/bench_full/18_amortized_add_lmm_scan.R --dir 02 --cores 30   # combine
# ==============================================================================
...
if (sys.nframe() == 0L) {
  ...
  cat("\nDone. Re-run sim/bench_full/36_aggregate.R to refresh summaries.\n")
}
