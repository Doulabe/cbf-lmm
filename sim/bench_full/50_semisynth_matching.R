# ==============================================================================
# 50_semisynth_matching.R
# Rerun the full semi-synthetic 1000G benchmark (all methods) on the canonical
# exact-era datasets (seed formulas of 44_exact_semisynth.R) and score with
# BOTH metrics:
...
# Usage:  Rscript sim/bench_full/50_semisynth_matching.R [--cores 5] [--B 200]
# ==============================================================================
...
source("sim/bench_full/02_utils_matching.R")
...
# --- canonical dataset construction (44_exact_semisynth.R) ---
