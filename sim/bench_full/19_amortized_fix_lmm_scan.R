...
#
# Usage:
#   Rscript sim/bench_full/19_amortized_fix_lmm_scan.R --cores 8
# ==============================================================================

source("sim/bench_full/00_config.R")
source("sim/bench_full/18_amortized_add_lmm_scan.R")   # imports seed_for_cell, context_for_cell, augment_one
