# ==============================================================================
# 65_make_geuvadis_table.R
# LaTeX table for the GEUVADIS cis-eQTL illustration (38_geuvadis_loci_scan.R),
...
# Usage : Rscript sim/bench_full/65_make_geuvadis_table.R [--out_dir results/bench_full/tables_cbf]
# ==============================================================================
