...
run_step "50 controlled" Rscript sim/bench_full/55_bayesr_long_controlled.R --cores 5
run_step "51 secondary"  Rscript sim/bench_full/56_bayesr_long_secondary.R --cores 5
run_step "52 realdata"   Rscript sim/bench_full/57_bayesr_long_realdata.R
