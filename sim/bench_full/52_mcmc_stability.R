# ==============================================================================
# 52_mcmc_stability.R
# MCMC convergence control for the two sampling comparators (robustness analysis request):
...
# Usage:  Rscript sim/bench_full/52_mcmc_stability.R [--cores 5] [--B 50]
# ==============================================================================

# --- robustness analysis-reserve guard: create sim/bench_full/SKIP_44 to defer this run ---
if (file.exists("sim/bench_full/SKIP_44")) {
  message("44_mcmc_stability deferred (robustness analysis reserve); remove sim/bench_full/SKIP_44 to run.")
  quit(save = "no")
}
