...
# 10_amortized_axis_n.R
# Scaling in n at fixed (m=5000, rho=0.95, K_true=5, mixed beta).
# n in {500, 1000, 3000} x sigma_g2 in {0, 0.5}  -> 6 cells x B reps.
#
# CLI:
#   Rscript 10_amortized_axis_n.R                    # run all 6 cells x B reps
#   Rscript 10_amortized_axis_n.R --n 1000 --sg 0.5  # one cell, all reps
#   Rscript 10_amortized_axis_n.R --n 1000 --sg 0.5 --rep 3  # single (cell, rep)
#   Rscript 10_amortized_axis_n.R --include-bslmm    # add BSLMM to method set
#   Rscript 10_amortized_axis_n.R --B 5              # override B
