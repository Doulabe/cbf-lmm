...
# rule as 70_make_amortized_aggregate_table.R), comparing the exact CBF-LMM row with the
# retired shared-kernel row and the external comparators.
#
# Usage: Rscript sim/bench_full/41_exact_aggregate.R
# ==============================================================================
