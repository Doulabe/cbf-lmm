# ==============================================================================
# 53_correlated_causals.R
# Same-block correlated-causal stress test (robustness analysis request): K*=3 causal
...
# Usage:  Rscript sim/bench_full/53_correlated_causals.R [--cores 5] [--B 100]
# ==============================================================================
