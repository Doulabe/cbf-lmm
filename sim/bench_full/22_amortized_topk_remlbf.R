...
#  MBF Top-K* numbers from 20_amortized_topk.R for direct
#  comparison.
#
...
#  require modifying log_BF_one() in 21_amortized_add_scores.R to fix
#  delta at REML; this is left to the planned full-grid REML-BF re-run.
#
#  Cells (same as 20_amortized_topk.R):
...
#    Rscript sim/bench_full/22_amortized_topk_remlbf.R --cores 6 --B 100
# ==============================================================================
...
#  Cell list (mirrors 20_amortized_topk.R) 
...
#  LaTeX table ------------------------------------------------------------
sink(TEX_OUT)
cat("% Auto-generated by sim/bench_full/22_amortized_topk_remlbf.R\n")
