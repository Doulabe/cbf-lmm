...
#  Mirrors the 4 analyses of 92_mouse_autosomes.R and
#  93_mouse_bmi_sex.R but evaluates delta by plug-in REML
...
#    Rscript sim/bench_full/94_mouse_reml_bf.R
# ==============================================================================
...
# Mirrors the algebra of plug_in_reml_eBIC() in 30_amortized_ablation.R but takes W
...
#  LaTeX table 
sink(TEX_OUT)
cat("% Auto-generated by sim/bench_full/94_mouse_reml_bf.R\n")
