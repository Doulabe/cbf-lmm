# ==============================================================================
# 61_make_summaries_figures.R
# Build per-cell summary CSVs for the exact rerun (same format as
# 36_aggregate.R) and regenerate the two manuscript figures via
# 66_make_cbf_figures.R logic pointed at the exact tree.
# Usage: Rscript sim/bench_full/61_make_summaries_figures.R
# ==============================================================================
...
# --- figures: run a path-swapped copy of 66_make_cbf_figures.R ------------------
src <- readLines("sim/bench_full/66_make_cbf_figures.R")
