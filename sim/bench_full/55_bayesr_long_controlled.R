...
# ORIGINAL per-axis seed formulas (40_exact_axes.R); all other method rows
...
# Usage: Rscript sim/bench_full/55_bayesr_long_controlled.R [--cores 5]
# ==============================================================================
...
# ── per-axis seed formulas (identical to 40_exact_axes.R) ───────────────────
